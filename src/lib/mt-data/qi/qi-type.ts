...
// Ref3 p56					Tam hop
  ...
  static  HOEGCOUNT= new QiType('HOEGGRP',false,'HOEG');

  static  PERIODLIFECYCLESTATUS= new QiType('PERLCYCLESTATUS',false,'PERLCYCLESTAT');
  static  PERIODELEMENTSTATUS= new QiType('PERELEMENTSTATUS',false,'PERLELEMENTSTAT');
  static  PERIODTRUNKSTATUS= new QiType('PERTRUNKSTATUS',false,'PERTSTAT');
  static  PERIODBRANCHESTATUS= new QiType('PERBRANCHESTATUS',false,'PERBSTAT');
  static  PERIODSTATUS= new QiType('PERSTATUS',false,'PERSTAT');

  static  YEARBIRTHTRUNKCLASH= new QiType('YEARBIRTHTRUNKCLASH',false,'YEARBIRTHTRUNKCLASH');
  static  YEARBIRTHBRANCHECLASH= new QiType('YEARBIRTHBRANCHECLASH',false,'YEARBIRTHBRANCHECLASH');
  static  YEARCONTROLBIRTHELEMENT= new QiType('YEARCONTROLBIRTHELEMENT',false,'YEARCONTROLBIRTHELEMENT');
  static  BIRTHCONTROLYEARELEMENT= new QiType('BIRTHCONTROLYEARELEMENT',false,'BIRTHCONTROLYEARELEMENT');
  static  YEARSTATUS= new QiType('YEARSTATUS',false,'YEARSTATUS');
  static  YEARTAMTAI= new QiType('YEARTAMTAI',false,'YEARTAMTAI');
